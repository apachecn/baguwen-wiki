...
> 原文：[https://zwmst.com/2803.html](https://zwmst.com/2803.html)
   ...
   [ *Java基础* ](https://zwmst.com/java%e5%9f%ba%e7%a1%80)*[ <time datetime="2021-09-10T09:42:17+08:00"> 2021-09-10 </time> ](https://zwmst.com/2803.html)  *   [Java 锁之乐观锁和悲观锁](#java-锁之乐观锁和悲观锁)
    *   [悲观锁](#悲观锁)
    *   [乐观锁](#乐观锁)
    *   [两种锁的使用场景](#两种锁的使用场景)
    *   [乐观锁的实现方式](#乐观锁的实现方式)
